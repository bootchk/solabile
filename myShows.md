...
These works had been shown previously:
- "Light Meter"
- "Solar Chime II"

These works had not been shown previously:
...
![My work titled Bell Pagoda, one unit](/assets/BellPagodaUnit.jpg)
...
Thus the mobile is assymetric.

Inspired by [George Rickey.](https://en.wikipedia.org/wiki/George_Rickey)
He must have been a master of the ball bearing.
...
Not a solar mobile, but a solar, kinetic lamp.
...
The green LED's gather light from the central LED lamp, and blink when they can.
Virtually kinetic, in the sense that blinking LED's seem like motion.

Once again, a static image does not do it justice.
Video at TODO

My [artist statement]({% link LightCubedArtistStatement.md %}) explains the technology, the efficiency of solar cells, and the political statement that I hoped the artwork makes.
